...
function Header() {
  ...
  const renderLines = () => {
    const bottomOpen = [
      {
        value:
          "M39.50625,9.5 C30.8788547,9.5 28.639837,0.5 20,0.5 C11.360163,0.5 8.88972652,9.5 0.5,9.5",
      },
    ];
    ...
    const bottomClosed = [
      {
        value:
          "M39.50625,9.5 C30.8788547,9.5 28.642962,9.5 20.003125,9.5 C11.363288,9.5 8.88972652,9.5 0.5,9.5",
      },
    ];
    ...
    const topOpen = [
      {
        value:
          "M39.50625,0.5 C30.8788547,0.5 28.642962,0.5 20.003125,0.5 C11.363288,0.5 8.88972652,0.5 0.5,0.5",
      },
    ];
    ...
    const topClosed = [
      {
        value:
          "M39.50625,0.5 C30.8788547,0.5 28.642962,9.5109931 20.003125,9.5109931 C11.363288,9.5109931 8.88972652,0.5 0.5,0.5",
      },
    ];
