...
function PlanetActionsView({ item, onChange }) {
              ...
              router.push(
                {
                  ...
                  query: { ...router.query, tab: 1, planetId: null },
                },
                undefined,
                { shallow: true }
              );
          ...
          planetDuplicate({
            ...
            callback: (data) => {
              ...
              router.push(
                {
                  pathname: router.pathname,
                  query: { ...router.query, tab: 1, planetId: data._id },
                },
                undefined,
                { shallow: true }
              );
...
export default PlanetActionsView;
