...
import IterationCollectionSettings from "./type/iteration_collection_settings";
...
function Drawer() {
  ...
  const renderDrawer = (type) => {
    switch (type) {
      ...
      case "hardware-collection-settings":
        return (
          <HardwareCollectionSettings hideDrawer={hideDrawer} enablePortal />
        );
      case "tier-settings":
      ...
      case "planet-settings":
        return <PlanetSettings hideDrawer={hideDrawer} enablePortal />;
      ...
      case "iteration-collection-settings":
        return (
          <IterationCollectionSettings hideDrawer={hideDrawer} enablePortal />
        );
      default:
        return;
    }
  ...
  if (app.drawerOpen) {
    return (
      <div
        className={`app-drawer ${classNames({
          "full-screen": app.fullScreen,
        })}`}
        style={style}
      >
        <div className={`app-drawer-background `} onClick={hideDrawer}></div>
